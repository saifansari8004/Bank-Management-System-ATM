...
public class Withdrawl extends JFrame implements ActionListener,KeyListener
{
    ...
    String pin;
    public Withdrawl(String pin_no) 
    {
        pin = pin_no;
        setSize(800,800);
        setLocation(300,0); 
        ...
        textJLabel2 = new JLabel("TO WITHDRAW: ");
        textJLabel2.setForeground(Color.WHITE);
        textJLabel2.setFont(new Font("System", Font.BOLD, 16));
        ...
        amtField.setBounds(310,285,120,25);
        amtField.addKeyListener(this);
        img_label1.add(amtField);
        
        withdrawButton = new JButton("WITHDRAW");
        withdrawButton.setBounds(250,330,100,35);
        withdrawButton.addActionListener(this);
        img_label1.add(withdrawButton);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        try
        {
            ...
            Date date = new Date();
            Conn con=new Conn();
            ResultSet rs = con.st.executeQuery("select * from bank where pin = '"+pin+"'");
            int balance = 0;
            while (rs.next()) 
            {
            ...
            if(ae.getSource()==withdrawButton)
            {
                ...
                {
                    Conn c1 = new Conn();
                    c1.st.executeUpdate("insert into bank values('"+pin+"', '"+date+"', 'Withdrawl', '"+amt+"')");
